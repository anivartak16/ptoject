    ...
    <div className="chatbot">
      ...
      <div className="chatbot-main">
        ...
        <div className="smart-suggestions">
          ...
          <button
            onClick={() =>
              sendMessage("What is the current wheat price?")
            }
            disabled={loading}
          >
            🌾 Wheat price
          ...
          <button
            onClick={() =>
              sendMessage("How can I find a buyer?")
            }
            disabled={loading}
          >
            🏪 Find buyer
          ...
          <button
            onClick={() =>
              sendMessage("How can I sell my produce?")
            }
            disabled={loading}
          >
            🛒 Sell produce
        ...
        <div className="app-tip">
          ...
          <div>
            <strong>Pro tip:</strong> Ask me about crop prices,
            buyers, selling, market trends and more.
          </div>
